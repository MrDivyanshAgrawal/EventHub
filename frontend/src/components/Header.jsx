    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          <Link to="/" className="flex items-center" aria-label="EventHub - Your Event Booking Solution">
            <img 
              src="/Logo.svg" 
              alt="EventHub - Your Event Booking Solution" 
                    ...
                    <div className="py-1">
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          ...
                          >
                            <ArrowRightEndOnRectangleIcon className="h-4 w-4 mr-3" />
                            Sign out
                          </button>
                        )}
                      </Menu.Item>
          ...
          {user ? (
            <div className="pt-4 pb-3 border-t border-gray-200">
              ...
              <div className="mt-3 px-2 space-y-1">
                <button
                  onClick={handleLogout}
                  className="flex items-center w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-100"
                  >
                  <ArrowRightEndOnRectangleIcon className="h-4 w-4 mr-3" />
                  Sign out
                </button>
