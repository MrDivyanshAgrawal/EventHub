        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/events" className="text-gray-400 text-xs sm:text-sm hover:text-white transition-colors">
                  Browse Events
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 text-xs sm:text-sm hover:text-white transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 text-xs sm:text-sm hover:text-white transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-400 text-xs sm:text-sm hover:text-white transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-gray-400 text-xs sm:text-sm hover:text-white transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
              ...
              {EVENT_CATEGORIES.map(category => (
                <li key={category.value}>
                  <Link 
                    ...
                    className="text-gray-400 text-xs sm:text-sm hover:text-white transition-colors flex items-center"
                  >
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-3 text-gray-400 text-xs sm:text-sm">
              <li className="flex items-start gap-2">
                ...
                <div>
                  <p>support@eventhub.in</p>
                  <p>info@eventhub.in</p>
                </div>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="text-center text-gray-400 text-xs sm:text-sm">
            ...
            <p className="mt-2">
              ...
              <Link to="/privacy" className="ml-1 hover:text-white">Privacy</Link>
            </p>
          </div>
        </div>
      </div>
